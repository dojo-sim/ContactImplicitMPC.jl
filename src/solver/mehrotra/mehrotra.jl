...
function interior_point_solve!(ip::Mehrotra21{T}) where T
    ...
    for j = 1:max_iter_inner
        ...
        elapsed_time += @elapsed begin
            ...
            αhaff, μaff = step_length(z_y1, z_y2, Δaff_y1, Δaff_y2, τu)
            ...
            linear_solve!(solver, Δ, rz, rm) # TODO this should not recompute the factorization of
            τ = progress(r_merit, ϵ_min=ϵ_min)
            αh = corrector_step_length(z_y1, z_y2, -Δ_y1, -Δ_y2; τ=τ)
