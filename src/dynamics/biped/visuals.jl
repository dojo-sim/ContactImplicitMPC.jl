function plot_lines!(vis::Visualizer, model::Biped, q::AbstractVector;
		r=0.035, offset=0.05, size=10, name::Symbol=:Biped, col::Bool=true, α=1.0)
	r_contact = r*8/7
...
function build_robot!(vis::Visualizer, model::Biped; name::Symbol=:Biped, r=0.035)
	r = convert(Float32, r)
...
function set_robot!(vis::Visualizer, model::Biped, q::AbstractVector;
		name::Symbol=:Biped, r=0.035)
...
function contact_point(model::Biped, q::AbstractVector)
	k_toe_1 = kinematics_3(model, q, body = :foot_1, mode = :toe)
