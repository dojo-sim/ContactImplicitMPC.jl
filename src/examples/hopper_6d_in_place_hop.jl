...
q0_ref = SVector{nq,T}([0.0, 0.0, 0.50, 0.0, 0.0, 0.5])
q1_ref = SVector{nq,T}([0.0, 0.0, 0.50, 0.0, 0.0, 0.5])
...
gait_path = joinpath(@__DIR__, "..", "dynamics", "hopper_6D", "gaits", "gait_in_place.jld2")
@save gait_path traj
...
traj = get_trajectory("hopper_6D", "gait_in_place", load_type=:joint_traj)
