...
urdf = joinpath(dir, "mesh", "a1.urdf")
...
mvis = MechanismVisualizer(mechanism, mechanism_visuals, vis[:Quadruped])
...
setvisible!(vis[:Quadruped], false)
setvisible!(vis[:ghost], false)
setvisible!(vis[:shadow], false)
