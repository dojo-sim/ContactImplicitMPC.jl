...
info = @benchmark compute_Δν!($s.Δνn, $s.Δν1, $s.Δν2, $s.Liis, $s.Ljis,
	$s.y, $s.idx_nq, $s.idx_nq2, $s.H)

@test info.memory == 0
@test info.allocs == 0

@code_warntype compute_Δν!(s.Δνn, s.Δν1, s.Δν2, s.Liis, s.Ljis, s.y, s.idx_nq, s.idx_nq2, s.H)
...
info = @benchmark compute_Δz!($s.Δu, $s.Δqa, $s.Δqb, $s.Δν1, $s.Δν2,
	$s.Aa, $s.Ab, $s.Ac, $s.Ba, $s.Q̃a, $s.Q̃b, $s.Q̃v, $s.R̃a,
...
@code_warntype compute_Δz!(s.Δu, s.Δqa, s.Δqb, s.Δν1, s.Δν2, s.Aa, s.Ab, s.Ac, s.Ba, s.Q̃a, s.Q̃b, s.Q̃v, s.R̃a, s.rlagu, s.rlagqa, s.rlagqb, s.H)
