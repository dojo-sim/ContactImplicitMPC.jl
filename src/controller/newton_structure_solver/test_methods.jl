...
s = ContactImplicitMPC.newton_structure_solver(nq, m, T,
...
ContactImplicitMPC.compute_Y!(s.Yiia, s.Yiib, s.Yiic, s.Yiid, s.Yija, s.Yijb, s.Yijc, s.Yijd,
	s.Aa, s.Ab, s.Ac, s.Ba, s.Q̃a, s.Q̃b, s.Q̃v, s.R̃a,
	s.tmp_nqnq, s.tmp_nqnq2, s.tmp_nqm, s.Inq, s.H)

info = @benchmark ContactImplicitMPC.compute_Y!($s.Yiia, $s.Yiib, $s.Yiic, $s.Yiid,
...
@code_warntype ContactImplicitMPC.compute_Y!(s.Yiia, s.Yiib, s.Yiic, s.Yiid,
	s.Yija, s.Yijb, s.Yijc, s.Yijd, s.Aa, s.Ab, s.Ac, s.Ba, s.Q̃a, s.Q̃b, s.Q̃v, s.R̃a,
	s.tmp_nqnq, s.tmp_nqnq2, s.tmp_nqm, s.Inq, s.H)

ContactImplicitMPC.update_Y!(s.Yiis, s.Yijs, s.Yii, s.Yij, s.Yiia, s.Yiib, s.Yiic, s.Yiid,
	s.Yija, s.Yijb, s.Yijc, s.Yijd, s.Yiiav, s.Yiibv, s.Yiicv, s.Yiidv,
	s.Yijav, s.Yijbv, s.Yijcv, s.Yijdv, s.H)
info = @benchmark ContactImplicitMPC.update_Y!($s.Yiis, $s.Yijs, $s.Yii, $s.Yij, $s.Yiia, $s.Yiib, $s.Yiic, $s.Yiid,
...
@code_warntype ContactImplicitMPC.update_Y!(s.Yiis, s.Yijs, s.Yii, s.Yij, s.Yiia, s.Yiib, s.Yiic, s.Yiid,
	s.Yija, s.Yijb, s.Yijc, s.Yijd, s.Yiiav, s.Yiibv, s.Yiicv, s.Yiidv,
	s.Yijav, s.Yijbv, s.Yijcv, s.Yijdv, s.H)
...
ContactImplicitMPC.compute_L!(s.Liis, s.Ljis, s.Yiis, s.Yijs, s.tmp_nn, s.tmp_nn2, s.H)

info = @benchmark ContactImplicitMPC.compute_L!($s.Liis, $s.Ljis, $s.Yiis, $s.Yijs, $s.tmp_nn, $s.tmp_nn2, $s.H)

@test info.memory == 0
@test info.allocs == 0

@code_warntype ContactImplicitMPC.compute_L!(s.Liis, s.Ljis, s.Yiis, s.Yijs, s.tmp_nn, s.tmp_nn2, s.H)
...
ContactImplicitMPC.compute_β!(s.βn, s.β1, s.β2, s.rlagu, s.rlagqa, s.rlagqb,
	s.rdyn1, s.rdyn2, s.Aa, s.Ab, s.Ac, s.Ba, s.Q̃a, s.Q̃b, s.Q̃v, s.R̃a, s.H)

info = @benchmark ContactImplicitMPC.compute_β!($s.βn, $s.β1, $s.β2, $s.rlagu, $s.rlagqa, $s.rlagqb,
	$s.rdyn1, $s.rdyn2, $s.Aa, $s.Ab, $s.Ac, $s.Ba, $s.Q̃a, $s.Q̃b, $s.Q̃v, $s.R̃a, $s.H)

@test info.memory == 0
@test info.allocs == 0

@code_warntype ContactImplicitMPC.compute_β!(s.βn, s.β1, s.β2, s.rlagu, s.rlagqa, s.rlagqb,
	s.rdyn1, s.rdyn2, s.Aa, s.Ab, s.Ac, s.Ba, s.Q̃a, s.Q̃b, s.Q̃v, s.R̃a, s.H)

@test norm((β - vcat([[s.β1[t]; s.β2[t]] for t = 1:T-1]...))) < 1.0e-12
@test norm((β - vcat(s.βn...))[1:s.nq]) < 1.0e-12

ContactImplicitMPC.compute_y!(s.y, s.Liis, s.Ljis, s.βn, s.H)

info = @benchmark ContactImplicitMPC.compute_y!($s.y, $s.Liis, $s.Ljis, $s.βn, $s.H)

@test info.memory == 0
@test info.allocs == 0

@code_warntype ContactImplicitMPC.compute_y!(s.y, s.Liis, s.Ljis, s.βn, s.H)

@test norm(vcat(s.y...) - L \ β, Inf) < 1.0e-12

ContactImplicitMPC.compute_Δν!(s.Δνn, s.Δν1, s.Δν2, s.Liis, s.Ljis, s.y, s.idx_nq, s.idx_nq2, s.H)

info = @benchmark ContactImplicitMPC.compute_Δν!($s.Δνn, $s.Δν1, $s.Δν2, $s.Liis, $s.Ljis,
	$s.y, $s.idx_nq, $s.idx_nq2, $s.H)

@test info.memory == 0
@test info.allocs == 0

@code_warntype ContactImplicitMPC.compute_Δν!(s.Δνn, s.Δν1, s.Δν2, s.Liis, s.Ljis, s.y, s.idx_nq, s.idx_nq2, s.H)
...
ContactImplicitMPC.compute_Δz!(s.Δu, s.Δqa, s.Δqb, s.Δν1, s.Δν2, s.Aa, s.Ab, s.Ac, s.Ba,
	s.Q̃a, s.Q̃b, s.Q̃v, s.R̃a, s.rlagu, s.rlagqa, s.rlagqb, s.H)

info = @benchmark ContactImplicitMPC.compute_Δz!($s.Δu, $s.Δqa, $s.Δqb, $s.Δν1, $s.Δν2,
	$s.Aa, $s.Ab, $s.Ac, $s.Ba, $s.Q̃a, $s.Q̃b, $s.Q̃v, $s.R̃a,
...
@code_warntype ContactImplicitMPC.compute_Δz!(s.Δu, s.Δqa, s.Δqb, s.Δν1, s.Δν2, s.Aa, s.Ab, s.Ac, s.Ba, s.Q̃a, s.Q̃b, s.Q̃v, s.R̃a, s.rlagu, s.rlagqa, s.rlagqb, s.H)

@test norm((Δz - vcat([[s.Δu[t]; s.Δqa[t]; s.Δqb[t]] for t = 1:T-1]...))) < 1.0e-12

ContactImplicitMPC.factorize!(s)
info = @benchmark ContactImplicitMPC.factorize!($s)
@code_warntype ContactImplicitMPC.factorize!(s)

ContactImplicitMPC.solve!(s)
info = @benchmark ContactImplicitMPC.solve!($s)
@code_warntype ContactImplicitMPC.solve!(s)

@test norm(Δ - vcat(vcat([[s.Δu[t]; s.Δqa[t]; s.Δqb[t]] for t = 1:T-1]...), vcat([[s.Δν1[t]; s.Δν2[t]] for t = 1:T-1]...)))  < 1.0e-12

# # test residual
# sim = ContactImplicitMPC.get_simulation("flamingo", "flat_2D_lc", "flat")
# model = sim.model
# env = sim.env
#
