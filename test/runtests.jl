...
# include("simulator/hopper_2D.jl") #TODO: set tests to raibert model #bad
# include("simulator/hopper_3D.jl") #bad
include("simulator/quadruped.jl")
include("simulator/open_loop.jl")
# include("simulator/biped.jl") #TODO: improve this test #bad
# include("simulator/flamingo.jl") #TODO: add this test #bad

# Controller
include("controller/objective.jl")
include("controller/linearized_step.jl")
include("controller/implicit_dynamics.jl")
# include("controller/linearized_solver.jl") #bad
