function build_robot!(vis::Visualizer, model::WallPendulum12; name::Symbol=:WallPendulum12,
...
function set_robot!(vis::Visualizer, model::WallPendulum12, x::AbstractVector;
		name::Symbol=:WallPendulum12, r = 0.01, n_leg::Int=30)
...
function build_disturbance!(vis::Visualizer, model::WallPendulum12; name::Symbol=:Pusher, r=0.01, α=1.0)
...
function set_disturbance!(vis::Visualizer, model::WallPendulum12, pθ::AbstractVector; name::Symbol=:Pusher, offset::Real=0.0)
	p = pθ[1:3]
	θ = pθ[4]
...
function animate_disturbance!(vis::Visualizer, anim::MeshCat.Animation, model::WallPendulum12,
