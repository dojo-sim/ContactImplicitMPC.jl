...
using JLD2
@save joinpath(@__DIR__, "inplace_trot_10Hz_double.jld2") qm um γm bm ψm ηm μm hm
@load joinpath(@__DIR__, "inplace_trot_10Hz_double.jld2") qm um γm bm ψm ηm μm hm
