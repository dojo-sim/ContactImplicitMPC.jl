...
conM = DTO.Constraint(constraints_M, nx + nθ + nx + model.nu, nu, indices_inequality=collect(16 .+ (1:32)))
conTT = DTO.Constraint(constraints_TT, nx + nθ + nx + model.nu, nu, indices_inequality=collect(16 .+ (1:32)))
