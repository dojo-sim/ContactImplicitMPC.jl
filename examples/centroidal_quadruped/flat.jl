...
# ## Initial conditions
q1_sim = [0.0; 0.0; 1.0; zeros(3); ones(12)]#[0; 0; 1; zeros(15)]
v1_sim = zeros(18)
# q1_sim, v1_sim = initial_conditions(ref_traj);

# ## Simulator
# sim = simulator(s, H_sim, h=h_sim, policy=p);
sim = simulator(s, 100, h=0.01)

# ## Simulate
simulate!(sim, q1_sim, v1_sim, verbose=true);
...
# ## Visualize
anim = visualize!(vis, model, sim.traj.q; Δt=0.01)
