...
# ## model
d1 = DTO.Dynamics((y, x, u, w) -> point_foot_quadruped_dyn1(model, env, [h], y, x, u, w), nx + nθ + nx + model.nu, nx, nu)
dt = DTO.Dynamics((y, x, u, w) -> point_foot_quadruped_dynt(model, env, [h], y, x, u, w), nx + nθ + nx + model.nu, nx + nθ + nx + model.nu, nu)
...
# RoboDojo.visualize!(vis, RoboDojo.point_foot_quadruped, [q_opt..., q_mirror...], Δt=h);
