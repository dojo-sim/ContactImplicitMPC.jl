...
using ContactImplicitMPC: Flamingo, plot_surface!, get_line_material, Point, kinematics_1, kinematics_2, kinematics_3, default_background!, Policy, cable_transform
import ContactImplicitMPC
import ContactImplicitMPC: visualize_meshrobot!, visualize_force!, policy
using Rotations
...
include(joinpath(@__DIR__, "..", "src", "controller", "pratt_policy.jl"))
