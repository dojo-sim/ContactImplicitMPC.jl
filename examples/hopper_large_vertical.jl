...
core = Newton(H, h, model, ref_traj, im_traj, obj = obj, opts = n_opts)
...
plot_surface!(vis, model.env, n=200)
...
traj = get_trajectory("hopper_2D", "gait_forward_high", load_type=:joint_traj)
